    ...
    <div className="row">
      <div className="col-md-6">
        <div className="registration-page py-4">
          ...
          >
            Edit Leave Application Of {props.editData["FirstName"]}{" "}
                      ...
                      <Col sm={10} className="form-input">
                        <Form.Control as="select" required>
                          ...
                          <option
                            value="Sick Leave"
                            selected={
                              props.editData["Leavetype"] == "Sick Leave"
                            }
                            disabled
                          >
                            Sick Leave
                          ...
                          <option
                            value="Paid Leave"
                            selected={
                              props.editData["Leavetype"] == "Paid Leave"
                            }
                            disabled
                          >
                            Paid Leave
                          ...
                          <option
                            ...
                            selected={
                              props.editData["Leavetype"] == "Maternity Leave"
                            }
                            disabled
                          >
                            Maternity Leave
                          ...
                          <option
                            ...
                            selected={
                              props.editData["Leavetype"] == "Paternity Leave"
                            }
                            disabled
                          >
                            Paternity Leave
