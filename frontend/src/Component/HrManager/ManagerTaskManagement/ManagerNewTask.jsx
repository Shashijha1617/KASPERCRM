...
import { MdArrowDropDown, MdArrowDropUp, MdOutlineCancel } from "react-icons/md";
...
const ManagerNewTask = () => {
  ...
  const handleTaskAction = async (taskID, taskName, adminMail, action) => {
    ...
    const { setStatus, statusKey, newStatus, message, toastMessage } = actionConfig;
    ...
    <div className="p-4">
      ...
      <div className="row mx-auto text-white">
        {tasks.filter(
          ...
          tasks
            .filter((task) => task.status === "Assigned" && task.managerEmail === email)
            .map((task) => (
              <div
                key={task._id}
                style={{
                ...
                >
                  ...
                  <div>
                    <div className="d-flex justify-content-between gap-3 my-2">
                      ...
                      <span className="d-flex flex-column">
                        <h6>Start Date</h6> <span style={{ width: "fit-content" }}>{getFormattedDate(task.startDate)}</span>
                      </span>
                      <span className="d-flex flex-column">
                        <h6>End Date</h6> <span style={{ width: "fit-content" }}>{getFormattedDate(task.endDate)}</span>
                      </span>
                    </div>
                    <div className="mt-4">
                    <span
                    ...
                    >
                      {expandedTaskId === task._id ?  <span>View Less  <MdArrowDropUp  className="fs-4"/></span> : <span> View Details <MdArrowDropDown className="fs-4" /></span>}
                  ...
                  {expandedTaskId === task._id && (
                    ...
                    <span className="d-flex flex-column gap-1">
                          ...
                          <span>
                            <div
                              style={{
                                display: expandedTaskId === task._id ? "flex" : "none",
                              }}
                            >
                    ...
                    <div className="d-flex flex-column gap-2 my-2">
                      ...
                      <div className="d-flex gap-3">
                        <button
                          onClick={() => handleTaskAction(task._id, task.Taskname, task.adminMail, "accept")}
                        ...
                        <button
                          onClick={() => handleTaskAction(task._id, task.Taskname, task.adminMail, "reject")}
          ...
          <div
            ...
            style={{ height: "80vh" }}
          >
            <img style={{ width: "30%", height: "auto" }} src={AssignTask} alt="Assign Task" />
            <p
              style={{
                color: darkMode ? "var(--primaryDashColorDark)" : "var(--primaryDashMenuColor)",
              }}
